...
It supports [InfluxDB](http://influxdb.com) with [Grafana](http://grafana.org/docs/features/influxdb), [Google Cloud Monitoring](https://cloud.google.com/monitoring/), [ElasticSearch](https://www.elastic.co/products/elasticsearch), [Google Cloud Logging](https://cloud.google.com/logging/), [Hawkular](http://www.hawkular.org), [Riemann](http://riemann.io), [Kafka](http://kafka.apache.org/) and [OpenTSDB](https://opentsdb.net/).
